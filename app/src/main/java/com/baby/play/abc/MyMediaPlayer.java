...
public class MyMediaPlayer implements OnBufferingUpdateListener, OnCompletionListener, MediaPlayer.OnPreparedListener {
	...
	public MyMediaPlayer(String videoUrl, SeekBar skbProgress) {
